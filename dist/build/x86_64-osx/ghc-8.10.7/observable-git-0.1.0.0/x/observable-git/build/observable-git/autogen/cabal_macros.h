...
/* package observable-git-0.1.0.0 */
#ifndef VERSION_observable_git
#define VERSION_observable_git "0.1.0.0"
#endif /* VERSION_observable_git */
#ifndef MIN_VERSION_observable_git
#define MIN_VERSION_observable_git(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_observable_git */
...
/* package modern-uri-0.3.4.4 */
#ifndef VERSION_modern_uri
#define VERSION_modern_uri "0.3.4.4"
...
#define CURRENT_COMPONENT_ID "observable-git-0.1.0.0-inplace-observable-git"
